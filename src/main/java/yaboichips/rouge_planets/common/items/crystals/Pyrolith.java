...
public class Pyrolith extends Item {
    ...
    private void sendFlameParticles(Level world, Entity user, double radius) {
        ...
        for (int i = 0; i < PARTICLE_COUNT; i++) {
            ...
            world.addParticle(ParticleTypes.FLAME, userPos.x() + xOffset, userPos.y() + yOffset, userPos.z() + zOffset, 0, 0, 0);
        }
    }


    private void applyFireAndDamageToEntities(Level world, Entity user, double radius) {
